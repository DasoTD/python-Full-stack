...
class UserProfile(models.Model):
    ...
    username= models.CharField(max_length=20, unique=True, default="dd")
    email= models.CharField(max_length=50, unique=True, default="dd")
    password = models.CharField(max_length=50,default="dd")
    phone_number= models.CharField(max_length=50, default=12)
